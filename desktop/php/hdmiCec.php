...
<div class="row row-overflow">
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
        <legend><i class="fa fa-headphones"></i>{{Mes dispositifs}}</legend> <!-- changer pour votre type d'équipement -->
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogic" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
    	<div class="row">
		        ...
		        <form class="form-horizontal">
		            <fieldset>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-lg-4">
		                    	<select id="sel_periphType" class="form-control eqLogicAttr" data-l1key="configuration" data-l2key="periphType">
	        ...
	        <div class="col-sm-6">
				...
				<div class="form-group">
	                    		...
	                    		<div class="col-lg-4">
	                        	<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="osdName" readonly/>
	                    		</div>
								<label class="col-lg-2 control-label">{{Marque :}}</label>
	                    		<div class="col-lg-4">
	                        	<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="vendor" readonly/>
	                    		</div>
				...
				<div class="form-group">
	                    		...
	                    		<div class="col-lg-4">
	                        	<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="logicalAddress" readonly/>
	                    		</div>
								<label class="col-lg-2 control-label">{{Adresse physique:}}</label>
	                    		<div class="col-lg-4">
	                        	<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="physicalAddress" readonly/>
	                    		</div>
	                            <div class="form-group">	
	                            <div style="text-align: center">
	                             <img src="plugins/hdmiCec/core/template/images/hdmiCec_icon.png" id="img_hdmiCecModel"  onerror="this.src='plugins/hdmiCec/core/template/images/hdmiCec_icon.png'" style="height : 280px;" />
	                            </div>
	                            </div>
	            </div>
			</div>
        ...
        <table id="table_cmd" class="table table-bordered table-condensed">
            <thead>
                <tr>
                	<th style="width: 300px;">{{Nom}}</th><th>{{Options}}</th><th>{{Actions}}</th>
                </tr>
            </thead>
            <tbody>
            </tbody>
